...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationUri(TestDB.TEST_LOCATION),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithDateUri(TestDB.TEST_LOCATION, TestDB.TEST_DATE),
                null,
                null,
                null,
                null
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDateUri(testLocation, testDate));
    ...
    static ContentValues createKalamazooLocationValues() {
        ...
        testValues.put(LocationEntry.COLUMN_LOCATION_CODE, KALAMAZOO_LOCATION_SETTING);
        testValues.put(LocationEntry.COLUMN_CITY_NAME, "Kalamazoo");
        testValues.put(LocationEntry.COLUMN_COORD_LATITUDE, 42.2917);
        testValues.put(LocationEntry.COLUMN_COORD_LONGITUDE, -85.5872);
